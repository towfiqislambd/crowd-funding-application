...
const SingleUser = () => {
    ...
    const { title, image, desc, status, campaign_type } = details;
    ...
    const handleDonate = () => {
        ...
        const donatedUser = { title, image, desc, status, campaign_type, displayName, email }
                ...
                details && <div className="container mx-auto px-5 lg:px-32 xl:px-40">
                    <div className="border bg-white rounded-lg shadow-lg grid grid-cols-1 lg:grid-cols-2 gap-8 items-center p-5">
                        ...
                        <div className="">
                            ...
                            <p className="text-gray-600 mb-2">{details.desc}</p>
                            <p className="text-gray-700 font-medium mb-1">Category: <span className="font-normal">{details.campaign_type}</span></p>
                            <p className="font-medium text-gray-700 mb-1">Status: <span className="font-normal">Active</span></p>
                            <p className="text-gray-700 font-medium text-base mb-1">Donation Amount: <span className="font-normal">25000</span></p>
                            <p className="text-gray-700 font-medium text-base mb-5">Deadline: <span className="font-normal">{details.date}</span></p>
