...
const Slider = () => {
    return (
        <div className="carousel w-full h-[550px] relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white space-y-6 px-5">
                    <h1 className="text-3xl md:w-2/3 mx-auto  md:text-4xl tracking-wide lg:text-5xl lg:leading-[3.5rem] font-semibold ">
                        ...
                        <span style={{ color: 'rgb(147 51 234)' }}>
                            <Typewriter
                                words={[
                                    ' your platform for crowdfunding success',
            ...
            <div id="slide2" className="carousel-item h-full relative w-full">
            ...
            <div id="slide3" className="carousel-item h-full relative w-full">
