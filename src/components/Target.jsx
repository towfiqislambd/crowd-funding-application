    ...
    return (
        <div className="container mx-auto px-5 py-20">
            ...
            <div data-aos="fade-up" data-aos-duration="1000" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                <div className="px-5 py-7 rounded-lg space-y-4 text-center bg-[rgba(0,0,0,0.1)]
                border-[2px] border-purple-500 transition-all shadow-lg">
                    ...
                    <h4 className="text-2xl text-gray-800 dark:text-gray-200 font-bold pt-1 mb-1">Growing Community</h4>
                ...
                border-[2px] border-purple-500 transition-all shadow-lg">
                    ...
                    <h4 className="text-2xl text-gray-800 dark:text-gray-200 font-bold pt-1 mb-1">Setup Team</h4>
                ...
                border-[2px] border-purple-500 transition-all shadow-lg">
                    ...
                    <h4 className="text-2xl text-gray-800 dark:text-gray-200 font-bold pt-1 mb-1">1000+ Institutions</h4>
                ...
                border-[2px] border-purple-500 transition-all shadow-lg">
                    ...
                    <h4 className="text-2xl text-gray-800 dark:text-gray-200 font-bold pt-1 mb-1">Permanent Campus</h4>
                    <p className="text-gray-600 dark:text-gray-400">As it the beginning step of our organization, We are offering lots of opportunity now.</p>
                </div>
            </div>
        </div>
